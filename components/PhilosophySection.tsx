        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-xl font-semibold text-white/70 mb-6">
              ...
              <a
                href="/about"
                className="inline-flex items-center gap-3 px-8 py-4 bg-white text-black font-semibold text-sm tracking-wide transition-all duration-300 hover:bg-white/90"
              >
            ...
            <div className="flex flex-col gap-4">
              ...
              {/* Card 1 */}
              <div className="flex items-start gap-5 border border-white/10 rounded-xl px-6 py-5 hover:border-white/20 transition-colors duration-300">
